...
CREATE TABLE `issued_books` (
  ...
  `status` int(1) DEFAULT 0 COMMENT '0=pending,1=approved,2=returned,3=overdue',
...
('System Admin', 'admin@library.edu', '$2y$10$pzV4qDRHuXNtOPUXl6NOdeIgLMoajYS2AXtdie2g6PxGPyPXgs0z2', '1234567890', 'admin'),
('Head Librarian', 'librarian@library.edu', '$2y$10$Yczv4BHpsaTWknmcVogXJOwNL9bCey0U8KtemEb8wFhmrlY2WhT4y', '1234567891', 'librarian');
...
('978-0596517748', 'JavaScript: The Good Parts', 4, 1, 'CS-004', 350.00, 'Essential JavaScript guide', 3, 3, 'O Reilly', 2008, '1st Edition', 176, 'Rack A3'),
...
('978-1449373320', 'Designing Data-Intensive Applications', 6, 1, 'CS-006', 1100.00, 'The big ideas behind reliable, scalable, and maintainable systems', 3, 3, 'O Reilly', 2017, '1st Edition', 616, 'Rack A3'),
...
('STU-2025-001', 'John Doe', 'student@library.edu', '$2y$10$Dj0ih1NzsUohEZ4oyFu1uehKfptXCc.DUYADt/jnNNN21O..b0pMC', '9876543210', '123 University Campus, City', 1, 2, 'approved', 'CARD-2025-001');
